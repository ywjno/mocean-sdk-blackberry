 ...
 */
public class WebViewInterstitialLegacy extends MainScreen implements FieldChangeListener {
...
//	int marginY = 0;
	...
	public WebViewInterstitialLegacy(final MASTAdview adserver, final AdserverInterstitial adserverInterstitial) {
		super(STYLE);
		thisScreen = this;
