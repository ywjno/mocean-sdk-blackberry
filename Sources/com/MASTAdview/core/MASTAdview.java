 ...
 */
public class MASTAdview extends AdserverBase {
	...
	private MASTAdview adserver = null;
	
	
	public MASTAdview(String campaign, String appID, int mode, String site, String zone, String ip, String keywords,
	...
	public MASTAdview (int site, int zone) {
	...
	public void show() {
		if (null != adserver) {
			WebViewInterstitial webViewInterstitial = new WebViewInterstitial(adserver);
