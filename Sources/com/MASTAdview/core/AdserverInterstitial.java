...
public final class AdserverInterstitial {
	...
	public AdserverInterstitial(int site, int zone) {
		adserver = new MASTAdview (site, zone);
//		UiApplication.getUiApplication().pushScreen(new WebViewInterstitialLegacy(adserver, this));
		}
	...
	public void pushScreen() {
		WebViewInterstitialLegacy webViewInterstitial = new WebViewInterstitialLegacy(adserver, this);
		adserver.setWebViewInterstitialLegacy(webViewInterstitial);
